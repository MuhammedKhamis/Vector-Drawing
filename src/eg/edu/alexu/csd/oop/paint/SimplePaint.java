...
public class SimplePaint extends JApplet {
     ...
     * application as well as as an applet. The main routine has nothing to do
     * with the function of this class as an applet.
     */
    ...
    public static class SimplePaintPanel extends JPanel implements MouseListener, MouseMotionListener {
        ...
        /*
         * The following variables are used when the user is sketching a curve
        ...
        public void paintComponent(Graphics g) {
            ...
            // rectangle will be colorSpacing - 3. There are 7 colored
            // rectangles,
            // so the available space is divided by 7. The available space
            // allows
             ...
             * applet. The color palette and Clear button will be drawn on top
             * of this. (This covers some of the same area as the border I just
             * drew.
             */
            ...
            /*
             * Draw the "Clear button" as a 50-by-50 white rectangle in the
             * lower right corner of the applet, allowing for a 3-pixel border.
             */
        ...
        private void changeColor(int y) {
            ...
            /*
             * Remove the hilite from the current color, by drawing over it in
             * gray. Then change the current drawing color and draw a hilite
